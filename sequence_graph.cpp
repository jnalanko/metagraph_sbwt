...
void call_sequences_from(const DeBruijnGraph &graph,
    ...
    throw std::runtime_error("Not implemented becaus reverse_complement is missing");
...
/*
    ...
    int jarno_num_threads = 1; // Jarno hack to make things compile
    ...
    if (call_unitigs) {
        ...
        //              \___      ___/
        //
        #pragma omp parallel for num_threads(jarno_num_threads)
